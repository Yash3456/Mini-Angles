...
const Menu = ({toggleModal,navi,setnavi,navigation}) => {
  ...
  return (
    ...
    <View style={{flex:1,paddingVertical:20,flexDirection:"column",backgroundColor:"white",width:"70%",borderTopRightRadius:20,borderBottomRightRadius:20}}>
      ...
      <Text style={{fontSize:20,fontWeight:"500",marginVertical:20,color:navi==="Learn"?"#FE804D":"#000000", textDecorationLine: navi === "Learn"?"underline":"none",fontFamily:fontsLoaded?'Poppins_Bold':null}} onPress={()=> {
        setnavi("Learn")
        toggleModal();
      }}>Learn</Text>
      <Text style={{fontSize:20,fontWeight:"500",marginVertical:20,color:navi==="Guideliness"?"#FE804D":"#000000", textDecorationLine: navi === "Guideliness"?"underline":"none",fontFamily:fontsLoaded?'Poppins_Bold':null}} onPress={()=> {
        setnavi("Home")
        navigation.navigate("Guidliness")
        toggleModal();
      }}>Guideliness</Text>
      </View>
