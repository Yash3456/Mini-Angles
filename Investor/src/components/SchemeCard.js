...
const SchemeCard = ({image,title,title2,title3,button,navigation,toggleModal3}) => {
  return (
    <View style={{flex:1,maxHeight:172,flexDirection:"row",marginVertical:10,borderRadius:20,backgroundColor:"#FE804D"}}>
       ...
       <Text style={{color:"#ffffff",marginTop:14,marginHorizontal:"8%",fontSize:16,fontWeight:"400",textDecorationLine:"underline"}} onPress={toggleModal3}>{button}</Text>
